...
show_source_toggle = Показати переключатель джерела
volume = Гучність
local = Локальні
server = Сервер
...
change = Змінити
heart_track_to_add = Вподобайте трек поки він грає, аби він відобразився тут.
heart_track_to_add_server = Вподобайте трек поки він грає, аби він відобразився тут і на вашому сервері.
...
# Error Messages
invalid_server_url = Не вірний адрес сервера
username_and_password_required = Потрібні ім'я користувача та пароль
login_failed = Помилка входу: { $error }
error_server_not_configured = Сервер не вірно налаштований або облікові дані відсутні
error_fetch_songs = Помилка при отримуванні пісень альбому '{ $album_id }': { $error }
...
no_tracks_in_library = Немає пісень у вашій біблотеці.
...
refresh_music_library = Оновити музикальну бібліотеку
